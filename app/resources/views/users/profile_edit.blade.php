        ...
        <div class="card-body">
          <form action="{{ route('profile.edit.comp', $user->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="d-flex align-items-center mb-3">
              <img id="userIcon" src="{{ asset('storage/' . $user->image) }}" class="rounded-circle me-3" alt="ユーザー画像" style="width: 100px; height: 100px;">
            ...
            <div class="card mt-4">
              ...
              <div class="card-body">
                ...
                <div class="mb-3">
                  ...
                  <input type="tel" class="form-control" id="tel" name="tel" value="{{ old('tel', $user->tel) }}">
                </div>

                <div class="mb-3">
                  <label for="postcode" class="form-label">郵便番号</label>
                  <input type="tel" class="form-control" id="postcode" name="postcode" value="{{ old('postcode', $user->postcode) }}">
                </div>
